...
public class TGS_FileHtml {
    ...
    public String toString() {
        ...
        sj.add(TGS_FileHtmlUtils.beginLines(browserTitle, addTableBorder, 5, 5, browserIconHrefPng, addDivCenter, bootLoaderJs, pageSizeAX, landscape).orElse(excuse -> excuse.getMessage()));
